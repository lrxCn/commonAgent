...
**当前建议下一步**：执行 **[109 - StudentListCard](./prompts/109-student-chat-list-card.md)**（可与 **108** ✅ 并行，均需 **107** ✅）。
...
**对话内学生工具批次（106–110）**：🔄 进行中（**106–108** ✅）；PRD [student-in-chat-client-actions.md](./prd/student-in-chat-client-actions.md)；重构 createStudent（对话内表单）+ 新增 listStudents + 创建后链式列表。
