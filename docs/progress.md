...
**当前建议下一步**：执行 **[107 - Front 类型与拆旧](./prompts/107-student-chat-front-foundation.md)**（对话内学生工具批次）。
...
**对话内学生工具批次（106–110）**：🔄 进行中（**106** ✅）；PRD [student-in-chat-client-actions.md](./prd/student-in-chat-client-actions.md)；重构 createStudent（对话内表单）+ 新增 listStudents + 创建后链式列表。
