...
**当前建议下一步**：执行 **[108 - CreateStudentFormCard](./prompts/108-student-chat-create-form-card.md)**（可与 **109** 并行，均需 **107** ✅）。
...
**对话内学生工具批次（106–110）**：🔄 进行中（**106–107** ✅）；PRD [student-in-chat-client-actions.md](./prd/student-in-chat-client-actions.md)；重构 createStudent（对话内表单）+ 新增 listStudents + 创建后链式列表。
