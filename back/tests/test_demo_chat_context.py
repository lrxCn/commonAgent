...
def _sample_tools() -> list[dict]:
    return [
        {
            "name": "jumpPage",
            "description": "Navigate the user to an in-app page. Allowed pages: home (首页), students (员工管理), admin-roles (角色管理, admin only), admin-users (用户管理, admin only), admin-kb (RAG/知识库管理, admin only). Use the slug exactly as listed.",
            "parameters": {
                "type": "object",
                "properties": {
                    "page": {
        ...
        {
            "name": "createStudent",
            "description": "Show an inline create-employee form in the chat. Optional prefill: student_no, name, class_name, status (active=在职, inactive=离职). The user submits the form in chat; do not assume the employee is already created.",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "listStudents",
            "description": "Show a paginated employee list inline in the chat. Optional filters: search (matches name/student_no/class_name), status (active/inactive), class_name. Pagination: offset (default 0), limit (default 10, max 100).",
            "parameters": {
                "type": "object",
                "properties": {
